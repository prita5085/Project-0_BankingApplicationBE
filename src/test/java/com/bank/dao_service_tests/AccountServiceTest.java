...
public class AccountServiceTest {
	...
	static ClientDao cd = new ClientDaoImpl();
	static AccountDao dao = new AccountDaoImpl();
	AccountService as = new AccountServiceImpl(dao);
	...
	public static void setUp() throws Exception {
		...
		testClient = cd.createClient(createClient);
	...
	public void A_createAccount() {
		...
		Account createdAccount1 = as.createAccount(createAccount1, newId);
		Account createdAccount2 = as.createAccount(createAccount2, newId);
		Account createdAccount3 = as.createAccount(createAccount3, newId);
		
		no1 = createdAccount1.getAccountNo();
		no2 = createdAccount2.getAccountNo();
		no3 = createdAccount3.getAccountNo();
		
		Account checkAcc = as.get_Account_By_AccNo_For_Client(no1, newId);
...
//		System.out.println(id1);
	...
	public void B_update_Account_By_AccNo_For_Client_Test() {
		...
		Account ua_Test = as.update_Account_By_AccNo_For_Client(updateAccount, newId);
		Account a2 = as.get_Account_By_AccNo_For_Client(no1, newId);
...
//		System.out.println(a2);
	...
	public void C_getAllAccountsById_Test() {
		List<Account> a3 = as.getAllAccountsById(newId);
	...
	public void D_get_All_Accounts_With_Range_Of_Amts() {
		List<Account> accounts = as.get_All_Accounts_With_Range_Of_Amts(8000, 100, newId);
		Assertions.assertNotNull(accounts);
	}
	
	@Test
	public void E_get_Account_By_AccNo_For_Client() {
		Account account = as.get_Account_By_AccNo_For_Client(no2, newId);
		Assertions.assertNotNull(account);
	}
		
	@Test
	public void F_deleteAccountTest() {
		Account a4 = as.deleteAccount(no1, newId);
		Account a5 = as.deleteAccount(no2, newId);
		Account a6 = as.deleteAccount(no3, newId);
		Client c = cd.deleteClient(newId);
